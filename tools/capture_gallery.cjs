...
(async()=>{
 ...
 await p.locator('[data-home-choice][data-journey=continue]').click();await p.locator('[data-journey=inspect]').click();await p.locator('[data-journey=next]').click();await p.locator('.journey-stage').waitFor();
