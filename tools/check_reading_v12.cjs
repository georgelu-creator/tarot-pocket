...
(async()=>{
 ...
 try{
  ...
  await p.locator('.ai-connection>summary').click();await p.locator('[data-ai-access]').fill('fixture-access-code-never-keep-in-backup');await p.locator('[data-reading=ai-request]').click();await p.locator('.ai-answer').waitFor();
