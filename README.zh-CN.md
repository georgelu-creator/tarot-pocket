...
[**开始体验 →**](https://georgelu-creator.github.io/tarot-pocket/?lang=zh) · [**下载离线版**](https://github.com/georgelu-creator/tarot-pocket/releases/download/v1.2.0/tarot-pocket-v1.2.0.html) · [English](README.md) · [后续计划](docs/ROADMAP.md)
...
v1.2.0 提供 **自由选择 78 张牌的连续学习**、按能力安排的间隔复习，以及独立的随身牌桌。手机打开网页即可使用，下载离线内容后可添加主屏幕，在旅途中继续学习。[本次体验设计与完整学习方案](docs/EXPERIENCE_V1_1.md)。
...
页面会显示真实下载与校验状态。更新未完成时保留旧版，不在学习中强制刷新。也可以下载 [单文件离线 HTML](https://github.com/georgelu-creator/tarot-pocket/releases/download/v1.2.0/tarot-pocket-v1.2.0.html)，用支持本地 JavaScript 的浏览器打开。
