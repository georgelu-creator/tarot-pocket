...
- 1.9.1 已通过完整本地检查及 PR #27 CI 并上线，构建为 `1.9.1-5c1cad187fe520cd`；公网手机尺寸检查通过。真实模型试读发现未知事项被写为未落实，追加 RP-1.2.2 约束。详见 [RELEASE_1_9_1](RELEASE_1_9_1.md) 与对应 PR；真实手机和教学效果仍需分别验收。
